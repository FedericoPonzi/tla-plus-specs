...
(*--algorithm non_repeatable_reads {
 ...
 variables status = StatusInitial, item_time = -1; {
    ...
    either {
            ...
            await status = StatusReading;
            \* TODO: is there a nicer way to do this?
            assert item_time = db_clock;
        } or {
...
\* BEGIN TRANSLATION (chksum(pcal) = "451b5320" /\ chksum(tla) = "561d4d3f")
...
DirtyReads == \A tr \in Transactions: status[tr] = StatusCompleted => item_time[tr] <= db_clock
